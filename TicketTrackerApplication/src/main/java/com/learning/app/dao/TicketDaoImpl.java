...
public class TicketDaoImpl implements TicketDao {
     ...
     * @throws RuntimeException If there is an error retrieving the searched tickets.
     */
    public List<Ticket> getAllSearchedTickets(String query) {
        try {
            ...
            if (sessionFactory != null) {
                ...
                return (List<Ticket>) session.createSQLQuery(sql)
                        .setParameter("query", "%" + query + "%").addEntity(Ticket.class).list();
            } else {
